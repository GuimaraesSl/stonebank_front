...
import { QrCodePixTransferDescriptionView } from "./QrCodePixTransferDescription.view";

export const QrCodePixTransferDescription: React.FC = () => {
  ...
  return (
    <QrCodePixTransferDescriptionView
